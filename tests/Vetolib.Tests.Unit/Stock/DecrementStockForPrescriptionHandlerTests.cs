...
// NOTE: Uses the same ClinicId as all other Stock test classes to avoid EF Core
// query-plan caching issues with the global query filter (Expression.Constant).

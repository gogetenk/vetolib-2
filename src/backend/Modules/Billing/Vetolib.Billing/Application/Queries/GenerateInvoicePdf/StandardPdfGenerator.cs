...
/// <summary>
/// Standard PDF generator for non-Factur-X countries (e.g., UAE).
/// Produces a simple QuestPDF invoice without embedded XML.
/// </summary>
internal class StandardPdfGenerator : IInvoicePdfGenerator
{

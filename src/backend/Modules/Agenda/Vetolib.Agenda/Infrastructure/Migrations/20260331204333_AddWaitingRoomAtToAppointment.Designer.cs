...
namespace Vetolib.Agenda.Infrastructure.Migrations
{
    ...
    [Migration("20260331204333_AddWaitingRoomAtToAppointment")]
    partial class AddWaitingRoomAtToAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vetolib.Agenda.Application.Domain.StaffSchedule", b =>
                {
                    ...
                    b.HasIndex("ClinicId", "UserId", "Date");

                    b.ToTable("staff_schedules", "agenda");
                });

            modelBuilder.Entity("Vetolib.Agenda.Application.Domain.VisitFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("visit_feedbacks", "agenda");
                });

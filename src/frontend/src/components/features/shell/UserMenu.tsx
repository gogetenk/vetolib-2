      ...
      {open && (
        ...
        >
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-lg px-2 py-2 text-[13px] font-medium text-destructive transition-all duration-200 ease-in-out hover:bg-red-50 hover:translate-x-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-300/50"
            role="menuitem"
          >

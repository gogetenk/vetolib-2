    ...
    <div className="space-y-6" data-testid="step-confirmation">
        ...
        <dl className="divide-y divide-gray-200">
          ...
          <div className="flex items-center gap-3 px-5 py-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                {pet.name} <span className="font-normal text-gray-500">({pet.species})</span>
              </dd>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 px-5 py-3.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                {time} <span className="text-xs text-gray-500">({consultationType.durationMinutes} min)</span>
              </dd>
            </div>
          </div>
      ...
      >
        <input
          ...
          className={cn(
            'mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500 cursor-pointer',
            'accent-emerald-600'
          )}
        />

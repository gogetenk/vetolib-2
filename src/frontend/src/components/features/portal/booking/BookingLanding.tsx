  ...
  return (
    <div className="space-y-6" data-testid="booking-landing">
      <div>
        ...
        <p className="text-stone-600 text-sm mt-1" data-testid="booking-landing-subtitle">
          {t('landing.subtitle')}
        </p>
      </div>
          ...
          <CardContent className="flex items-center gap-4 py-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="text-sm text-stone-700">{nextAppointment.petName}</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div
          ...
          className="flex flex-col gap-3 rounded-xl border border-stone-200 bg-white p-6 shadow-sm hover:border-emerald-400 hover:shadow-md transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 min-h-[44px]"
        ...
        <div
          ...
          className="flex flex-col gap-3 rounded-xl border border-stone-200 bg-white p-6 shadow-sm opacity-60 cursor-not-allowed"
          aria-disabled="true"
        >

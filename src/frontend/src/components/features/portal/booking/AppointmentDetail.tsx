  ...
  if (notFound || !appt) {
    return (
      <div className="text-center py-12" data-testid="appointment-detail-not-found">
        <p className="text-gray-700">{t('myAppointments.notFound')}</p>
        <Button
          variant="ghost"
  ...
  return (
    <div className="space-y-6" data-testid="appointment-detail">
      ...
      <div className="flex items-start justify-between gap-4">
        <h1 className="text-xl font-bold text-gray-900" data-testid="appointment-detail-title">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">{t('confirmation.date')}</p>
            <p className="text-sm font-medium text-gray-900" data-testid="appointment-detail-date">
              {formattedDate}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">{t('myAppointments.timeLabel')}</p>
            <p className="text-sm font-medium text-gray-900" data-testid="appointment-detail-time">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">{t('myAppointments.vetLabel')}</p>
            <p className="text-sm font-medium text-gray-900" data-testid="appointment-detail-vet">
        ...
        <div className="flex items-start gap-3">
          <User className="w-5 h-5 text-gray-400 mt-0.5 flex-shrink-0" />
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">{t('myAppointments.petLabel')}</p>
            <p className="text-sm font-medium text-gray-900" data-testid="appointment-detail-pet">
              {appt.petName}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">{t('myAppointments.clinicLabel')}</p>
            <p className="text-sm font-medium text-gray-900" data-testid="appointment-detail-clinic">
              {appt.clinicName}
            </p>
            <p className="text-xs text-gray-500" data-testid="appointment-detail-address">
              {appt.clinicAddress}
            </p>
          </div>
        </div>
        ...
        {appt.notes && (
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wide font-medium">{t('myAppointments.notesLabel')}</p>
              <p className="text-sm text-gray-700" data-testid="appointment-detail-notes">
                {appt.notes}
              </p>
            </div>
          </div>
      ...
      {canAct && (
        <div className="flex flex-col sm:flex-row gap-3" data-testid="appointment-detail-actions">
          <Button
            ...
            className="flex-1 border-gray-300 text-gray-700 hover:border-emerald-400"
            onClick={() => {

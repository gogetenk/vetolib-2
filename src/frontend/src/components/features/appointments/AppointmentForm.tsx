...
const SPECIES_OPTIONS: Species[] = ['Dog', 'Cat', 'Bird', 'Rabbit', 'Horse', 'Camel', 'Exotic', 'Falcon', 'Reptile']
...
const schema = z.object({
  ...
  species: z.enum(['Dog', 'Cat', 'Bird', 'Rabbit', 'Horse', 'Camel', 'Exotic', 'Falcon', 'Reptile'] as [Species, ...Species[]], { message: 'Please select a species' }),

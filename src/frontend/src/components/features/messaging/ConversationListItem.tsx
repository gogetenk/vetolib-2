...
const CATEGORY_COLOR: Record<MessageCategory, string> = {
  ...
  Administrative: 'bg-muted text-foreground ring-border/50',
  Feedback: 'bg-purple-100 text-purple-700 ring-purple-200',
  Other: 'bg-muted text-muted-foreground ring-border/50',
}
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-1.5">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-bold text-[14px] text-foreground truncate">{conversation.ownerName}</span>
        </div>

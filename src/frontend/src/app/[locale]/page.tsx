                  ...
                  <ScrollReveal key={key} delay={i * 100} direction="fade-up">
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent text-primary transition-all duration-300 group-hover:bg-secondary group-hover:scale-110">
